            ...
            <?php if ($isDisplayIcomoonTable): ?>
                <div class="card mb-3 ">
                    ...
                    <div class="card-body">
                                            ...
                                            <div class="quickicon-info">
                                                ...
                                                <div class="quickicon-icon">
                                                    <i style="font-size: <?php echo $font_size; ?>px;"
                                                       class="icon-<?php echo $icomoonIcon->iconId; ?>"></i>
                                                </div>
                        ...
                        <h5>Count icomoon icons: <span class="badge bg-secondary"><?php echo count($css_icomoon_icons); ?></span></h5>
                    </div>
                </div>
            <?php endif; ?>
                ...
                <div class="card mb-3 ">
                    ...
                    <div class="card-body">
                                    ...
                                    <li class="quickicon quickicon-single">
                                        <a href="#">
                                            <div class="quickicon-info">
                                                ...
                                                <div class="quickicon-icon">
                                                    <i style="font-size: <?php echo $font_size; ?>px;"
                                                       class="fa fa-<?php echo $systemIcon->iconId; ?>"></i>
                        ...
                        <h5>Count J! CSS standard font awesonme icons: <span
                                class="badge bg-secondary"><?php echo count($css_joomla_system_icons); ?></span></h5>
                    </div>
                </div>
            <?php endif; ?>
