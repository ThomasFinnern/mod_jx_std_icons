...
{
	static function displayTechDetail($description, $link)
	{
		?>
		<div class="mb-3">
	...
	static function displayIcon_asQuickicon($iconName, $iconClass, $icon_font_size, $name_font_size)
	{
		?>
	...
	static function displayIcon($iconName, $iconClass, $icon_font_size, $name_font_size)
	{
		?>
