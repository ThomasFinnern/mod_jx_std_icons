...
class mod_jx_std_iconsHelper
{
    ...
    public array $scssIconValues = [];
    public array $scss_awesome_std_names = [];
    public array $scss_awesome_brand_names = [];
     ...
     * @since version 0.1
     */
    public function cssfile_extractIcons($cssPathFileName = '', $isFindIcomoon = false, $isCollectBrands = false)
    {
...
//				if ($isCollectBrands)
//				{
//					$css_brand_names = self::lines_collectScssIconNames($lines);
//				}
...
//		            $test = 'test01';
     ...
     * @since version 0.1
     */
    public function lines_extractCssFontAwesome45($lines = [])
    {
        $css_form_icons = [];
...
//	 */
//	public
//	function lines_collectScssIconNames4($lines = [])
//	{
//
//		$css_brand_names = [];
//
...
//		{
//			$OutTxt = '';
//			$OutTxt .= 'Error executing lines_collectScssIconNames4: "' . '<br>';
//			$OutTxt .= 'Error: "' . $e->getMessage() . '"' . '<br>';
//
//			$app = Factory::getApplication();
//			$app->enqueueMessage($OutTxt, 'error');
...
//            ksort ($iconListByCharValue);
     ...
     * @since version
     */
    public function extractFawIconProperties6(string $firstLine): array
    {
        // debug address-book
     ...
     * @since version
     */
    public function extractFawIconProperties45(string $firstLine): array
    {
        // debug address-book
        if (str_contains($firstLine, 'address-book'))
        {
